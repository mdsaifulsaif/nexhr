    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-light p-4">
      <div className="dashboard-card w-full max-w-md p-8 md:p-10 !shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-title text-center uppercase tracking-tight">Welcome Back</h2>
          <p className="text-subtitle mt-1">Enter your credentials to access account</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                onChange={(e) => setFormData({...formData, email: e.target.value})} // 4. Updating state
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                onChange={(e) => setFormData({...formData, password: e.target.value})} // 4. Updating state
        ...
        <div className="mt-8 text-center">
          <p className="text-subtitle">
           ...
           <Link href="/register">
            <span className="ml-2 text-primary font-bold hover:underline cursor-pointer">Create Account</span>
           </Link>
          </p>
        </div>
      </div>
