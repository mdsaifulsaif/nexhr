    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-light p-4">
      <div className="dashboard-card w-full max-w-md p-8 md:p-10 !shadow-2xl">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-subtitle mt-1 text-center font-medium">Join AdsFixter to manage your team</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          >
            ...
            {!loading && <RiArrowRightLine className="group-hover:translate-x-1 transition-transform" />}
          </button>
        </form>
